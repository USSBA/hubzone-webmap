...
SecureHeaders::Configuration.default do |config|
  ...
  config.csp = {
      ...
      script_src: %w('self' 'unsafe-eval' 'unsafe-inline' localhost:3000 *.newrelic.com *.nr-data.net *.google.com *.digitalgov.gov *.google-analytics.com *.gstatic.com *.cloudflare.com *.googletagmanager.com *.atlassian.net *.hotjar.com *.googleapis.com),
