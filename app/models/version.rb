...
class Version
  ...
  private def config_version
    { major:       VERSION_CONFIG[:hubzone_map_version][:major],
      minor:       VERSION_CONFIG[:hubzone_map_version][:minor],
      patch:       VERSION_CONFIG[:hubzone_map_version][:patch],
      pre_release: VERSION_CONFIG[:hubzone_map_version][:pre_release] }
  end
end
