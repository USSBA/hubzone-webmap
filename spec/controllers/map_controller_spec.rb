...
RSpec.describe MapController do
  describe "parses latlng queries" do
    ...
    query = described_class.new.parse_search_query(latlng: "35.86456960744962,-97.87994384765625")
    it "will be URI parsed" do
  ...
  describe "parse text search" do
    ...
    query = described_class.new.parse_search_query(search: "8 market place baltimore md")
    it "will be URI parsed" do
