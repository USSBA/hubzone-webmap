...
RSpec.describe VersionController, vcr: false, type: :request do
  ...
  describe "Get version data in html" do
    ...
    it "should show the current version of the api software" do
  ...
  describe "Get version data in json" do
    ...
    it "should return the major version of the api software" do
      expect(json[:major]).to eq(100)
    end
    it "should return the minor version of the api software" do
      expect(json[:minor]).to eq(50)
    end
    it "should return the patch version of the api software" do
      expect(json[:patch]).to eq(1000)
    end
    it "should return the pre_release version of the api software" do
      expect(json[:pre_release]).to eq('zeta')
    end
    it "should return the commit of the api software" do
      expect(json[:commit_sha]).not_to be_nil
    end
    it "should return the tag of the api software" do
      expect(json[:tag]).not_to be_nil
    end
    it "should return the delta of the api software" do
